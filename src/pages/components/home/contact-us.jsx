              ...
              >
                <div className="row h-100">
                  <div className="col-6 flex-fix overlay-maroon">
                    ...
                    <div>
                      <div className="top">
                        <h2>READY TO CREATE BETTER, TOGETHER?</h2>
                      </div>
                          ...
                          >
                            ...
                            >
                              ...
                              <a
                                ...
                                className="dropdown-item"
                                onClick={(e) =>
                                  this.onSubjectSelected("Booking", e)
                                }
                              >
                                Booking
                              </a>
                              ...
                              <a
                                ...
                                className="dropdown-item"
                                onClick={(e) =>
                                  this.onSubjectSelected("Other", e)
                                }
                              >
                                Other
                              </a>
                ...
                <div className="row h-100">
                  ...
                  <div className="col-6 flex-fix overlay-maroon">
                    ...
                    <div>
                      <div className="top">
                        <h3>
                          MAKING GREAT $%*# HAPPEN TAKES THE RIGHT PEOPLE.
                        </h3>
                      </div>
                      <div className="bottom">
                        <p>
                          Work hard, play harder, and enjoy the heck out of
                          both. We create better for everyone in BlockchainWorks
                          because we work hard to make this a place that you can
                          look forward to being part of. Intrigued? We're
                          looking for great people to help us keep building
                          something special.
                        </p>
                    ...
                    <div className="col-6 flex-fix overlay-maroon">
                      ...
                      <div>
                        ...
                        <div className="bottom">
                          <p>
                            Work hard, play harder, and enjoy the heck out of
                            both. We create better for everyone in
                            BlockchainWorks because we work hard to make this a
                            place that you can look forward to being part of.
                            Intrigued? We're looking for great people to help us
